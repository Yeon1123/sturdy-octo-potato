		...
		<header id="header" class="hoc clear">
			...
			<nav id="mainav" class="fl_right">
				<ul class="clear">
					...
					<!--공지사항 메뉴-->
						<ul>
							<li class="submenu"><a href="notice.html">충남대 공지사항</a></li>
							<!--충남대 공지사항-->
							<li class="submenu"><a href="#">기숙사 공지사항</a></li>
							<!--기숙사 공지사항-->
							<li class="submenu"><a href="#">SW 사업단 공지사항</a></li>
							<!--SW 공지사항-->
							<li class="submenu"><a href="#">컴퓨터공학과 공지사항</a></li>
							<!--컴공 공지사항-->
						</ul></li>
	...
	<div class="wrapper row3">
		...
		<div id="join">
			<div id="wrapper">
				...
				<br>
				<br> <font color="blue"><%=memberBean.getName()%></font>님 가입을
				축하드립니다. <br>
				<br>
